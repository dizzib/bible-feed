...
extension Persister on Feed {
  ...
  void loadStateOrDefaults() {
    _book = _readingList.getBook(_sharedPreferences.getString(_storeKeyBookKey) ?? _readingList[0].key);
  ...
  Future _saveState() async {
    ...
    await _sharedPreferences.setString(_storeKeyBookKey, _book.key);
